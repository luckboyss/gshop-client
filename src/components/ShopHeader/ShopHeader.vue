<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="modalShow = true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="activityShow = true">
      ...
      <div class="shop-brief-modal" v-show="modalShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont iconClose" @click="modalShow = false"></span>
          </div>
        </div>
      ...
      <div class="activity-sheet" v-show="activityShow">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close">
            <span class="iconfont iconClose" @click="activityShow = false"></span>
          </div>
        </div>
